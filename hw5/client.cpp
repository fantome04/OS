...
int main()
{
    ...
    while(true)
    {
        ...
        if(in.size() == 2)
        {
            ...
            {
                std::cout<<__LINE__<<std::endl;
                int res = ptr->get_cell_curr_balance(std::stoi(in[1]));
                if(res == -1)
        ...
        else if(in.size() == 3)
        {
            if(in[0] == "setmin")
            {
                bool res = ptr->set_cell_min_amount(std::stoi(in[1]), std::stoi(in[2]));
                if(!res)
                    std::cout<<"invalid operation"<<std::endl;
                else
            ...
            {
                bool res = ptr->set_cell_max_amount(std::stoi(in[1]), std::stoi(in[2]));
                if(!res)
                    std::cout<<"invalid operation"<<std::endl;
                else
